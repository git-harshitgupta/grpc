...
public class RequestValidator {
    ...
    public static Optional<Status> validateAccount(int accountNumber){
        ...
        return Optional.of(Status.INVALID_ARGUMENT.withDescription("Account number should be between 1 to 10"));
    }
    ...
    public static Optional<Status> hasSufficientBalance(int amount,int balance){
        ...
        return Optional.of(Status.FAILED_PRECONDITION.withDescription("Account doesn't have sufficient balance"));
    }
